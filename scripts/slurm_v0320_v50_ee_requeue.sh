...
# ============================================================
# StarVLA Custom v0320 v50 EE (16D end-effector) on kempner_requeue
# 1 node x 4 H200 80GB, DeepSpeed ZeRO-2, QwenPI
#
# Data: place_cup5_tray1 (clean1, wp5) + place_stapler_stand (clean1, wp5)
...
accelerate launch \
  ...
  --datasets.vla_data.data_mix custom_v0320_v50_ee \
  ...
  --run_id v0320_v50_ee_qwenPI_requeue \
  --wandb_project starVLA_v50 \
  --wandb_entity hca
