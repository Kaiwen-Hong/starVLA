#!/usr/bin/env bash
# Split custom_v0309_v32_ee_repo (merged LeRobot dataset, 16D EE-space) into per-task directories
#
# Input:  $LAB_ROOT/.cache/huggingface/lerobot/custom_v0309_v32_ee_repo/
# Output: playground/Datasets/CustomEE_v32/ (3 task variant directories)
#
# Episode order in the merged repo (alphabetical by HDF5 dir name):
#   ep   0- 99: place_container_plate_clean1_ee
#   ep 100-199: place_container_plate_wp5_ee
#   ep 200-299: place_object_stand_clean1_ee
#
# Usage: bash split_custom_v0309_v32_ee.sh [workers]
...
SRC="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0309_v32_ee_repo"
DST="${REPO_ROOT}/playground/Datasets/CustomEE_v32"
...
echo ""
echo "Done. Ready to train with data_mix=custom_v0309_v32_ee"
