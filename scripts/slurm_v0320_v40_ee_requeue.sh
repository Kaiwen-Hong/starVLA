...
# ============================================================
# StarVLA Custom v0320 v40 EE (16D end-effector) on kempner_requeue
# 1 node x 4 H200 80GB, DeepSpeed ZeRO-2, QwenPI
#
# Data: place_cup_tray (clean1, wp5) + place_stapler_stand (clean1, wp5)
...
accelerate launch \
  ...
  --run_id v0320_v40_ee_qwenPI_requeue \
  --wandb_project starVLA_v40 \
  --wandb_entity hca
