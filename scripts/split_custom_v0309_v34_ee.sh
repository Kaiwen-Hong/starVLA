#!/usr/bin/env bash
# Split custom_v0309_v34_ee_repo (merged LeRobot dataset, 16D EE-space) into per-task directories
#
# Input:  $LAB_ROOT/.cache/huggingface/lerobot/custom_v0309_v34_ee_repo/
# Output: playground/Datasets/CustomEE_v34/ (3 task variant directories)
#
# Episode order in the merged repo (alphabetical by HDF5 dir name):
#   ep   0- 99: place_container_plate_clean2_ee
#   ep 100-199: place_container_plate_wp4_ee
#   ep 200-299: place_object_stand_clean2_ee
#
# Usage: bash split_custom_v0309_v34_ee.sh [workers]
...
SRC="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0309_v34_ee_repo"
DST="${REPO_ROOT}/playground/Datasets/CustomEE_v34"
...
TASKS=(
    place_container_plate_clean2_ee
    place_container_plate_wp4_ee
    place_object_stand_clean2_ee
)
...
echo ""
echo "Done. Ready to train with data_mix=custom_v0309_v34_ee"
