#!/usr/bin/env bash
# Split custom_v0320_v62_ee_repo (merged LeRobot dataset, 16D EE-space) into per-task directories
#
# Input:  $LAB_ROOT/.cache/huggingface/lerobot/custom_v0320_v62_ee_repo/
# Output: playground/Datasets/CustomEE/ (3 task variant directories)
#
# Episode order in the merged repo (alphabetical by HDF5 dir name):
#   ep    0-249: place_cup5_tray5_clean1_ee
#   ep  250-499: place_cup5_tray5_wp5_ee
#   ep  500-749: place_stapler_stand_clean1_ee
#
# Usage: bash split_custom_v0320_v62_ee.sh [workers]
...
python3 -c "
import json
m = json.load(open('${DST}/place_cup5_tray5_clean1_ee/meta/modality.json'))
...
echo ""
echo "Done. Ready to train with data_mix=custom_v0320_v62_ee"
