#!/usr/bin/env bash
# Split custom_v0309_v33_ee_repo (merged LeRobot dataset, 16D EE-space) into per-task directories
#
# Input:  $LAB_ROOT/.cache/huggingface/lerobot/custom_v0309_v33_ee_repo/
# Output: playground/Datasets/CustomEE_v33/ (4 task variant directories)
#
...
#
# Usage: bash split_custom_v0309_v33_ee.sh [workers]
...
SRC="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0309_v33_ee_repo"
DST="${REPO_ROOT}/playground/Datasets/CustomEE_v33"
...
echo ""
echo "Done. Ready to train with data_mix=custom_v0309_v33_ee"
