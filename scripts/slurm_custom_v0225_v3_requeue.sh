#!/bin/bash
#SBATCH --job-name=starVLA_v0225v3
...
# ============================================================
# StarVLA Custom v0225_v3 (20 variants, clean + hv/lv) on kempner_requeue
...
accelerate launch \
  ...
  --datasets.vla_data.data_mix custom_v0225_v3 \
  ...
  --run_id custom_v0225_v3_qwenOFT_requeue \
  --wandb_project starVLA_Custom_v0225_v3 \
