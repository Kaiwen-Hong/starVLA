...
# ============================================================
# StarVLA Custom v0320 v62 EE (16D end-effector) on kempner_requeue
...
accelerate launch \
  ...
  --datasets.vla_data.data_mix custom_v0320_v62_ee \
  ...
  --run_id v0320_v62_ee_qwenPI_requeue \
  --wandb_project starVLA_v62 \
  --wandb_entity hca
