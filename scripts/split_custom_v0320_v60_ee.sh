#!/usr/bin/env bash
# Split custom_v0320_v60_ee_repo (merged LeRobot dataset, 16D EE-space) into per-task directories
#
# Input:  $LAB_ROOT/.cache/huggingface/lerobot/custom_v0320_v60_ee_repo/
...
#
# Usage: bash split_custom_v0320_v60_ee.sh [workers]
...
SRC="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0320_v60_ee_repo"
...
echo ""
echo "Done. Ready to train with data_mix=custom_v0320_v60_ee"
