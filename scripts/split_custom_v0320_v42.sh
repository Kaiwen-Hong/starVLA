#!/usr/bin/env bash
# Split custom_v0320_v42_repo (merged LeRobot dataset, 14D joint-space) into per-task directories
#
# Input:  $LAB_ROOT/.cache/huggingface/lerobot/custom_v0320_v42_repo/
# Output: playground/Datasets/Custom/ (3 task variant directories)
#
...
#
# Usage: bash split_custom_v0320_v42.sh [workers]
...
SRC="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0320_v42_repo"
...
echo ""
echo "Done. Ready to train with data_mix=custom_v0320_v42"
