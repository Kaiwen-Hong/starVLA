...
#
# Runs all v41/v42/v52 models on their trained tasks.
...
#   bash r-preference/eval-local-v4152/run_eval_batch.sh [seed] [step]
#
...
EVAL_CONFIGS=(
    "v41|place_cup_tray|demo_clean"
    "v41|place_stapler_stand|demo_clean"
    "v42|place_cup_tray|demo_clean"
    "v42|place_stapler_stand|demo_clean"
    "v52|place_cup5_tray1|demo_clean"
    "v52|place_stapler_stand|demo_clean"
)
