#!/usr/bin/env bash
# ============================================================
# Step 1: Download v41/v42/v52 checkpoints from HuggingFace
#
...
#
# Usage:
#   bash r-preference/eval-local-v4152/1_download_checkpoints.sh
# ============================================================
set -euo pipefail
...
MODELS=(
    "v0320_v41_qwenOFT_finetune_v2"
    "v0320_v42_qwenOFT_finetune_v2"
    "v0320_v52_qwenOFT_finetune_v1"
)
...
if $ALL_OK; then
    ...
    echo "Next step: bash r-preference/eval-local-v4152/2_run_policy_server.sh v42"
else
    echo ""
