...
Across five preference axes in simulation, the source model labels the unlabeled target with \textbf{96.4\%} accuracy, and SPT improves preference-following by \textbf{[20]} points over a finetune baseline that does not self-label, with task success unchanged.
