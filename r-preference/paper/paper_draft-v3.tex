...
\textcolor{red}{make it more concise}
...
\textcolor{red}{I think many descriptions here are more like setup that should exist in the appendix instead of the main text, you can refer to the appendix and make the narrative here more concise to follow}
...
For \emph{strike strategy}, we label a direct vs.\ bank-shot preference on air hockey and transfer it to billiards (cue the ball into a pocket directly or off a cushion). As in simulation, the
...
\begin{table}[t]
  ...
  task success on two cross-task settings, SPT vs.\ B0. }
  \label{tab:real_main}
  \begin{tabular}{llccccc}
    \hline
    & & \multicolumn{2}{c}{Following Pref. Rate\ } & \multicolumn{2}{c}{Success Rate} \\
    Setting & Preference & B0 & SPT & B0 & SPT \\
    \hline
