#!/usr/bin/env bash
# ============================================================
# v71 OFT finetune v2 — Training only (data must be ready)
#
...
#
# Data: place_cup1_tray5 (clean1, wp4) + place_stapler_stand (clean1)
...
#
# Usage:
#   bash r-preference/0331-v71-training-finetune-version2.sh 2>&1 | tee v71_finetune_v2.log
# ============================================================
...
LEROBOT_REPO="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0320_v71_repo"

SPLIT_TASKS=(
  place_cup1_tray5_clean1
  place_cup1_tray5_wp4
...
DATA_MIX="custom_v0320_v71"
RUN_ID="v0320_v71_qwenOFT_finetune_v2"
WANDB_PROJECT="starVLA_v71_finetune_v2"
...
echo "Pipeline:  v71 OFT finetune v2 (training only)"
echo "============================================"
