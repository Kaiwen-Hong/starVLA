#!/usr/bin/env bash
# ============================================================
# v42 OFT finetune v2 — All-in-one pipeline
#
...
#
# Usage:
#   bash r-preference/0320-v42-training-finetune-version2.sh 2>&1 | tee v42_finetune_v2.log
# ============================================================
...
EPISODE_NUM=250
TRAINING_DATA_DIR="training_data/custom_v0320_v42"
REPO_ID="custom_v0320_v42_repo"
...
DATA_MIX="custom_v0320_v42"
RUN_ID="v0320_v42_qwenOFT_finetune_v2"
WANDB_PROJECT="starVLA_v42_finetune_v2"
...
echo "Pipeline:  v42 OFT finetune v2 (joint-space, RoboTwin2-All)"
echo "============================================"
...
if [ -f "${LEROBOT_DEST}/meta/info.json" ]; then
  ...
  LOCAL_CACHE="/scratch/lerobot_tmp_v42"
  mkdir -p "$LOCAL_CACHE"
