#!/usr/bin/env bash
# ============================================================
# v42 OFT finetune v2 — Training only (data must be ready)
#
...
#
# Usage:
#   bash r-preference/0331-v42-training-finetune-version2.sh 2>&1 | tee v42_finetune_v2.log
# ============================================================
...
LEROBOT_REPO="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0320_v42_repo"
...
echo "Pipeline:  v42 OFT finetune v2 (training only)"
echo "============================================"
