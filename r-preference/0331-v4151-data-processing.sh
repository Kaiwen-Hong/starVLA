...
#   bash r-preference/0331-v41-training-finetune-version2.sh
...
#
# Usage:
#   bash r-preference/0331-v4151-data-processing.sh 2>&1 | tee v4151_data.log
# ============================================================
...
echo "============================================"
echo "Node:      $(hostname)"
echo "Pipeline:  v41 + v51 data processing (sequential)"
echo "============================================"

cd "${KEMPNER_REPO}/policy/pi05"

# ============================================================================
# v41: 3 variants, 750 episodes
# ============================================================================
STEP_LOG "v41: Processing raw -> HDF5 (joint-space)"
...
V41_TDATA="training_data/custom_v0320_v41"
V41_REPO="custom_v0320_v41_repo"

process_dataset "v41" "$V41_TDATA" "${V41_VARIANTS[@]}"

STEP_LOG "v41: Generating LeRobot dataset"

generate_lerobot "v41" "$V41_TDATA" "$V41_REPO" 750
...
V41_DEST="${KEMPNER_CACHE}/huggingface/lerobot/${V41_REPO}"
V51_DEST="${KEMPNER_CACHE}/huggingface/lerobot/${V51_REPO}"

python3 -c "
import json, pathlib
for name, path in [('v41', '${V41_DEST}'), ('v51', '${V51_DEST}')]:
...
echo "  bash r-preference/0331-v41-training-finetune-version2.sh"
