#!/usr/bin/env bash
# ============================================================
# v72 OFT finetune v2 — Training only (data must be ready)
#
...
#
# Data: place_cup1_tray5 (clean1, wp5) + place_stapler_stand (clean1)
#       3 variants, 250 episodes each, 750 total
#
# Prerequisite: run 0331-v7172-data-processing.sh first!
#
# Prerequisites:
...
#
# Usage:
#   bash r-preference/0331-v72-training-finetune-version2.sh 2>&1 | tee v72_finetune_v2.log
# ============================================================
...
LEROBOT_REPO="${LAB_ROOT}/.cache/huggingface/lerobot/custom_v0320_v72_repo"

SPLIT_TASKS=(
  place_cup1_tray5_clean1
  place_cup1_tray5_wp5
...
DATA_MIX="custom_v0320_v72"
RUN_ID="v0320_v72_qwenOFT_finetune_v2"
WANDB_PROJECT="starVLA_v72_finetune_v2"
...
echo "Pipeline:  v72 OFT finetune v2 (training only)"
echo "============================================"
...
if [ ! -f "${LEROBOT_REPO}/meta/info.json" ]; then
  ...
  echo "Run 0331-v7172-data-processing.sh first!"
  exit 1
fi
