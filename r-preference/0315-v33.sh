#!/usr/bin/env bash
# ============================================================
# v33-ee 训练脚本（交互式 GPU 节点直接运行）
#
# v33 = 4 variants: place_container_plate (clean2, wp4) + place_object_stand (clean2, wp4)
# 400 episodes, 16D EE space, clean2 environment
#
# 前提：已在 4xH100/H200 计算节点上
# 用法：bash r-preference/0315-v33.sh
# ============================================================
set +u
...
accelerate launch \
  ...
  --datasets.vla_data.data_root_dir playground/Datasets/CustomEE_v33 \
  --datasets.vla_data.data_mix custom_v0309_v33_ee \
  ...
  --run_id v0309_v33_ee_qwenPI_requeue \
  --wandb_project starVLA_v33 \
  --wandb_entity hca
