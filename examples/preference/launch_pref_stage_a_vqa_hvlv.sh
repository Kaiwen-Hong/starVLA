#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage A MAIN-METHOD (VQA cotrain) — HVLV category
#   Q: "Question: far from or near the obstacle? Answer:"  A: "far"(hv) / "near"(lv)
...
echo "============================================"
echo "Run:         pref_main_stage_a_v1_VQA_hvlv"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_a_vqa_hvlv.yaml \
