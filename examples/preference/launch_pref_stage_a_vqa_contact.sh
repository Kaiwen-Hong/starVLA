#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage A MAIN-METHOD (VQA cotrain) — CONTACT category
#   Contact = canonical name for legacy "giveobj".
#   Q: "Question: low or high contact at grasp? Answer:"
#     A: "low" (pref_key=25) / "high" (pref_key=75).
#   Spec:    50k steps (same as original giveobj VQA), grad_ckpt OFF (H200 141GB).
# ============================================================
set +u
...
echo "============================================"
echo "Run:         pref_main_stage_a_v1_VQA_contact"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_a_vqa_contact.yaml \
