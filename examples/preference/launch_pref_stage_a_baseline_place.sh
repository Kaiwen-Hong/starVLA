#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage A baseline (no VQA) — PLACE category
#   Data:    /mnt/localssd/$USER/pref/data/place
...
#
# Usage:
#   bash examples/preference/launch_pref_stage_a_baseline_place.sh
#   NUM_GPUS=4 bash examples/preference/launch_pref_stage_a_baseline_place.sh
#   MAX_STEPS=200 NO_SAVE=1 bash examples/preference/launch_pref_stage_a_baseline_place.sh   # smoke
# ============================================================
set +u
...
[ -z "$DATA_ROOT" ] && { echo "ERROR: pref/data/place not found on /mnt/localssd/{kaiwenh,kevin}"; exit 1; }
...
echo "============================================"
echo "Run:         pref_baseline_stage_a_v1_noVQA_place"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_a_baseline_place.yaml \
