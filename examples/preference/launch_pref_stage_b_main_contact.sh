#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage B MAIN — contact (put_boxdrink3_plate, 100 ep)
#   Warm-start from VQA-Stage-A 35k.
#   Pseudo-labels from r-preference/eval/pref_pseudo_labels_contact_B.json
#   (mid_8 + |logit_gap|>=10 filter → 92/100 kept @ 100% pseudo-vs-GT acc)
...
CACHE_PATH="r-preference/eval/pref_pseudo_labels_contact_B.json"
...
echo "============================================"
echo "Run:           pref_main_stage_b_v1_contact"
echo "Node:          $(hostname) ($(whoami))"
echo "DATA_ROOT:     $DATA_ROOT"
echo "PSEUDO CACHE:  $CACHE_PATH"
echo "WARM-START:    VQA-Stage-A 35k (contact)"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_b_main_contact.yaml \
