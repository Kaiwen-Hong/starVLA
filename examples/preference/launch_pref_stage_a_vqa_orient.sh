#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage A MAIN-METHOD (VQA cotrain) — ORIENT category
#   Q: "Question: horizontal or vertical grasp? Answer:"  A: "horizontal"(0) / "vertical"(90)
#   Run on:  H200 (per user plan 2026-05-23; grad_ckpt=false in YAML)
...
echo "============================================"
echo "Run:         pref_main_stage_a_v1_VQA_orient"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_a_vqa_orient.yaml \
