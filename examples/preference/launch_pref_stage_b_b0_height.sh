#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage B B0 (baseline) — height (place_playingcards1_box, 100 ep)
...
echo "============================================"
echo "Run:           pref_b0_stage_b_v1_height"
echo "Node:          $(hostname) ($(whoami))"
echo "DATA_ROOT:     $DATA_ROOT"
echo "CACHE:         (B0 — no cache)"
echo "WARM-START:    no-VQA Stage A 25k (height baseline)"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_b_b0_height.yaml \
