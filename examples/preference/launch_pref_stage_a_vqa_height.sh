#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage A MAIN-METHOD (VQA cotrain) — HEIGHT category
#   Q: "Question: high or low drop? Answer:"   A: "high"/"low"
#   Run on:  H100 (per user plan 2026-05-23; grad_ckpt=true in YAML)
# ============================================================
set +u
...
[ -z "$DATA_ROOT" ] && { echo "ERROR: pref/data/height not found"; exit 1; }
...
echo "============================================"
echo "Run:         pref_main_stage_a_v1_VQA_height"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_a_vqa_height.yaml \
