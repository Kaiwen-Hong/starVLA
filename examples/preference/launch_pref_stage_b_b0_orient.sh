#!/usr/bin/env bash
# ============================================================
# Pref-VLA Stage B B0 (baseline) — orient (move_can5_away, 100 ep)
...
echo "============================================"
echo "Run:           pref_b0_stage_b_v1_orient"
echo "Node:          $(hostname) ($(whoami))"
echo "DATA_ROOT:     $DATA_ROOT"
echo "CACHE:         (B0 — no cache)"
echo "WARM-START:    no-VQA Stage A 25k (orient baseline)"
...
accelerate launch \
  ...
  --config_yaml examples/preference/train_files/starvla_pref_stage_b_b0_orient.yaml \
