...
Download checkpoints from outsider86/DiscreteRTC:
  - fastumi_pickandplace_qwenDiscreteDiffusion_329v3 (steps_20000)
...
def main():
    ...
    path = snapshot_download(
        ...
        allow_patterns=[
            "fastumi_pickandplace_qwenDiscreteDiffusion_329v3/config.yaml",
            "fastumi_pickandplace_qwenDiscreteDiffusion_329v3/dataset_statistics.json",
            "fastumi_pickandplace_qwenDiscreteDiffusion_329v3/summary.jsonl",
            "fastumi_pickandplace_qwenDiscreteDiffusion_329v3/**/steps_20000_pytorch_model.pt",
        ],
        token=token,
        max_workers=8,
    )
    print(f"Checkpoint downloaded to: {path}")
    print(f"  - fastumi_pickandplace_qwenDiscreteDiffusion_329v3 (steps_20000)")
