...
accelerate launch      \
    ...
    --datasets.vla_data.data_mix fastumi_pickandplace_ur5_0314-v3       \
    ...
    --run_id fastumi_pickandplace_discrete_diffusion_real_0314_no_state_no_static_frames       \
...
accelerate launch \
 ...
 --num_processes 8 \
  ...
  --run_root_dir ./results/Checkpoints \
  --run_id fastumi_pickandplace_qwenPI_no_state_no_static_frames \
  --wandb_project starVLA_FastUMI \
  --wandb_entity 2200011093-peking-university