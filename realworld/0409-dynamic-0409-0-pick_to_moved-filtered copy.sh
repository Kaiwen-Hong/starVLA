...
accelerate launch      \
    ...
    --datasets.vla_data.data_mix dynamic-0409-0-pick_to_moved-filtered       \
    ...
    --run_id fastumi_pickandplace_qwenDiscreteDiffusion_0409_0_pick_to_moved_filtered \
    --wandb_project starVLA_FastUMI_dynamic_0409_0_pick_to_moved_filtered \
...
accelerate launch \
 ...
 --num_processes 8 \
  ...
  --trainer.is_resume true \
  --run_root_dir ./results/Checkpoints \
  --run_id fastumi_pickandplace_qwenPI_0409_0_pick_to_moved_filtered \
  --wandb_project starVLA_FastUMI_dynamic_0409_0_pick_to_moved_filtered \
  --wandb_entity 2200011093-peking-university \
  --hf_repo_id outsider86/DiscreteRTC \
