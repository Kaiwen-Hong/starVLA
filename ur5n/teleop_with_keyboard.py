...
Controls (world frame):
    ...
    Step size: 1 cm / 0.05 rad per key press.
    Q / Esc → quit

Usage:
    python ur5n/teleop_with_keyboard.py
    python ur5n/teleop_with_keyboard.py --arm left
    python ur5n/teleop_with_keyboard.py --step 0.02 --rot-step 0.1
"""
...
def key_to_delta(key, step, rot_step):
    ...
    # Rotation (axis-angle delta in world frame)
    rot_map = {
        'Z': (0, 0, 0, -rot_step, 0, 0),   # Roll -
        'X': (0, 0, 0, +rot_step, 0, 0),   # Roll +
        'C': (0, 0, 0, 0, -rot_step, 0),   # Pitch -
        'V': (0, 0, 0, 0, +rot_step, 0),   # Pitch +
        'B': (0, 0, 0, 0, 0, -rot_step),   # Yaw -
        'N': (0, 0, 0, 0, 0, +rot_step),   # Yaw +
    }
