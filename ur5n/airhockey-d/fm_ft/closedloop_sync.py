#!/usr/bin/env python3
"""
Air-hockey synchronous closed-loop control (QwenPI, 2-D world XY).
...
Usage:
    ...
    python ur5n/airhockey-d/fm/closedloop_sync.py
    python ur5n/airhockey-d/fm/closedloop_sync.py --n_actions 8
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Air-hockey sync closed-loop (QwenPI, 2-D world XY)")
    ...
    if args.save_rollout:
        ...
        rollout_dir = Path("ur5n/airhockey-d/fm/rollouts_sync") / f"sync_{ts_str}"
    ...
    # ── Print config + arm ─────────────────────────────────────────
    print(f"\n{'=' * 60}")
    print(f"  Air-hockey Sync Closed-Loop (QwenPI)")
