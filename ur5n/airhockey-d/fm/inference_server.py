#!/usr/bin/env python3
"""
StarVLA inference server — air-hockey (QwenPI / DiT-S, 2-D world XY).
...
Default socket is /tmp/starvla_infer_airhockey.sock so this server can
run side by side with the DD/fm servers (which use other sockets).
...
Usage:
    ...
    python ur5n/airhockey-d/fm/replay_openloop_eval.py --use_server
    python ur5n/airhockey-d/fm/live_openloop_eval.py   --use_server
...
def load_model(checkpoint_path):
    ...
    # and is a no-op for replay (already 256).
...
def main():
    parser = argparse.ArgumentParser(
        description="StarVLA inference server — air-hockey QwenPI variant")
