...
Usage:
    python ur5n/fm/openloop_eval.py
    python ur5n/fm/openloop_eval.py --num_samples 500
    python ur5n/fm/openloop_eval.py --checkpoint path/to/other.pt --data_mix dynamic-329-v3
"""
