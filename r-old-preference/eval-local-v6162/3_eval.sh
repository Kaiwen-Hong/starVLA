...
#   bash r-preference/eval-local-v6162/3_eval.sh <version> <task_name> <task_config> [seed] [gpu_id]
#
# Examples:
#   # v62: trained on place_cup5_tray5 (clean1, wp5) + place_stapler_stand (clean1)
#   bash r-preference/eval-local-v6162/3_eval.sh v62 place_cup5_tray5 demo_clean 0 0
#   bash r-preference/eval-local-v6162/3_eval.sh v62 place_stapler_stand demo_clean 0 0
#
#   # v61: trained on place_cup5_tray5 (clean1, wp4) + place_stapler_stand (clean1)
#   bash r-preference/eval-local-v6162/3_eval.sh v61 place_cup5_tray5 demo_clean 0 0
#   bash r-preference/eval-local-v6162/3_eval.sh v61 place_stapler_stand demo_clean 0 0
#
...
DEPLOY_YML="${STARVLA_ROOT}/r-preference/eval-local-v6162/deploy_policy_${VERSION}.yml"
