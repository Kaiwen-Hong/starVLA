...
Usage:
    python r-preference/eval-local-v4152/visualize_attention.py \
        --input_dir results/attention_maps/v42/
"""
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory containing step_*.npz files (e.g., results/attention_maps/v42/)",
    )
    parser.add_argument(
