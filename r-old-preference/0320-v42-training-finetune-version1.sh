#!/usr/bin/env bash
# ============================================================
# v42 OFT finetune 训练脚本（交互式 GPU 节点直接运行）
#
...
#
# 数据：place_cup_tray (clean1, wp5) + place_stapler_stand (clean1)
#       3 variants, 250 episodes each, 750 total
#
# 用法：
#   bash r-preference/0320-v42-training-finetune-version1.sh
# ============================================================
set +u
...
accelerate launch \
  ...
  --datasets.vla_data.data_mix custom_v0320_v42 \
  ...
  --run_id v0320_v42_qwenOFT_finetune_v1 \
  --wandb_project starVLA_v42_finetune \
  --wandb_entity hca
